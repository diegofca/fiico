...
import 'package:control/modules/budgets/view/emptyView/budgets_empty_view.dart';
...
class BudgetArchivedSuccessView extends StatelessWidget {
  const BudgetArchivedSuccessView({
    Key? key,
